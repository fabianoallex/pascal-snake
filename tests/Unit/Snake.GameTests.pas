...
{ Testes de Snake.Game (DUnitX). Mesma cobertura de tests\Unit\fpc\Snake.GameTests.pas
  (FPCUnit), com corpos identicos (Snake.DUnitXCompat existe para isso): toda
  mudanca aqui vai para la' na mesma sessao. Conferir com
  python <skill>/scripts/verify_test_mirrors.py --root . }
...
type
  [TestFixture]
  TSnakeGameTests = class
  public
    [Test] procedure NewGame_IsReadyWithThreeSegments;
    [Test] procedure NewGame_HeadAtCenterFacingRight;
    [Test] procedure NewGame_FoodOnFirstFreeCellWithFixedRandom;
    [Test] procedure CellAt_ReportsHeadAndBody;
    [Test] procedure Create_TooSmallBoard_Raises;
    [Test] procedure Step_WhenReady_DoesNothing;
    [Test] procedure Step_MovesHeadOneCellAndKeepsLength;
    [Test] procedure ChangeDirection_RejectsReverseAndSame;
    [Test] procedure ChangeDirection_TwoQuickTurnsAreBothApplied;
    [Test] procedure ChangeDirection_QueueHoldsAtMostTwo;
    [Test] procedure ChangeDirection_WhilePaused_IsRejected;
    [Test] procedure TogglePause_StopsAndResumes;
    [Test] procedure Step_EatingFoodGrowsAndScores;
    [Test] procedure Step_AfterEating_FoodReappearsOffTheSnake;
    [Test] procedure Step_HittingWall_EndsGame;
    [Test] procedure Step_WrapWalls_ComesOutOnOppositeSide;
    [Test] procedure Step_BitingItself_EndsGame;
    [Test] procedure Step_IntoCellTheTailIsLeaving_IsAllowed;
    [Test] procedure TickInterval_SpeedsUpAndHasFloor;
    [Test] procedure Step_FillingTheBoard_WinsTheGame;
  end;
...
initialization
  TDUnitX.RegisterTestFixture(TSnakeGameTests);
